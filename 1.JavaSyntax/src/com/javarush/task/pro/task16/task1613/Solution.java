...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        if (
                (dayOfWeek == DayOfWeek.FRIDAY && dateTime.getHour()>=WEEKEND_START_FRIDAY_CUT_OFF_HOUR)
                || dayOfWeek == DayOfWeek.SATURDAY
                || (dayOfWeek == DayOfWeek.SUNDAY && dateTime.getHour()<WEEKEND_END_SUNDAY_CUT_OFF_HOUR)
        ){
            return true;
        }else {
            return false;}
