...
//        return Stream.empty();
        return languages.stream().sorted((rank1, rank2) -> rank2.getRanking().compareTo(rank1.getRanking()));
//        return languages.stream().sorted((rank1, rank2) -> Double.compare(rank1.getRanking(),rank2.getRanking()));
        // можно и с помощью метода comparingDouble, но он сортирует только по возрастанию
